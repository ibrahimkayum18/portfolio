    ...
    <div className="flex flex-col lg:flex-row min-h-screen ">
      <div className="drawer lg:drawer-open lg:w-80 ">
        ...
        <div className="drawer-side">
          ...
          ></label>
          <ul className="menu p-4 w-64 md:w-80 min-h-full bg-zinc-900 text-white fixed py-20 lg:pt-10 z-20">
            <div className=" mx-auto mb-10">
              {/* <h2 className="text-white text-3xl text-center lg:visible">S M Ibrahim Kayum</h2> */}
              <img
